package app.pokemon.pokemonlist
...
import app.pokemon.di.data.models.PokeListEntry
import app.pokemon.repository.PokemonRepository
import app.pokemon.util.Constants.PAGE_SIZE
...
class PokemonListViewModel @Inject constructor(
    ...
    private var cashedPokemonList = listOf<PokeListEntry>()
